...
\hypersetup{
  ...
  urlcolor = black,
  pdfauthor = {\name},
  pdfkeywords = {biology, stereotaxic surgery, neuroscience, biotechnology, molecular technology, research, rodent, naked mole rat, viral vector, chemogenetics, optogenetics, neural tracing, mouse, mice},
  pdftitle = {\name: Resume},
  pdfsubject = {Resume},
  pdfpagemode = UseNone
}
